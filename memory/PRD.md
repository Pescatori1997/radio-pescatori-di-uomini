...
- **#2 Latenza**: spiegazioni bibliche GPT-5.5 ~22-26s (output lungo), navigazione ~2s. Da decidere con l'utente: modello più veloce vs streaming vs risposte più concise.
