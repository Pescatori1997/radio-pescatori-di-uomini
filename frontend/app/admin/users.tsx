...
const SECTIONS: { key: string; label: string }[] = [
  ...
  { key: "achievements", label: "Traguardi del Cammino" },
  { key: "merch", label: "Merchandising" },
  { key: "schedule", label: "Palinsesto" },
  { key: "prayers", label: "Preghiere" },
  { key: "messages", label: "Messaggi & Testimonianze" },
  { key: "team", label: "Team" },
  { key: "finance", label: "Trasparenza Economica" },
  { key: "donations", label: "Donazioni" },
  { key: "donate_config", label: "Sostieni il Progetto" },
  { key: "notifications", label: "Notifiche" },
  { key: "reports", label: "Segnalazioni" },
  { key: "library_folders", label: "Cartelle Biblioteca" },
  { key: "content_folders", label: "Assegna contenuti" },
  { key: "home_layout", label: "Layout Home" },
  { key: "nav_icons", label: "Personalizzazione Navigazione" },
  { key: "section_names", label: "Nomi delle sezioni" },
  { key: "dashboard", label: "Dashboard" },
  { key: "stats", label: "Statistiche" },
  { key: "activity", label: "Registro Attività" },
  { key: "settings", label: "Impostazioni (avanzato)" },
  { key: "users", label: "Utenti (avanzato)" },
];
